...
@Component({
  selector: 'app-correspondance-notes-generator-modal',
  templateUrl: './correspondance-notes-generator-modal.component.html',
  styleUrls: ['./correspondance-notes-generator-modal.component.css']
})
export class CorrespondanceNotesGeneratorModalComponent implements OnInit {
