...
@Component({
  selector: 'app-kyireport',
  templateUrl: './kyireport.component.html',
  styleUrls: ['./kyireport.component.css']
})
export class KyireportComponent implements OnInit {
  ...
  getClientBiReports()
  {
    ...
    this.bi.GetBiReport(formbody).pipe().subscribe(
      (res) => {
        ...
        {
          if(this.LinkDetails[i].Report_Name=='KYI')
          {
