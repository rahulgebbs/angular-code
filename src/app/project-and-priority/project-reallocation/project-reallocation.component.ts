...
export class ProjectReallocationComponent implements OnInit {
  ...
  showCellRenderer(params) {
    ...
    eGui.innerHTML = `<button style="color: #fff;background-color: #5bc0de;" class="btn label label-info square-btn cursor" data-action-type="update" title="Re-Allocate">Re-Allocate</button>`;
    return eGui;
  }
