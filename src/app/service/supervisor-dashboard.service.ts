...
export class SupervisorDashboardService {
  ...
  getAllocated_Counts(Id){
    
    return this.http.get(environment.ApiUrl + '/api/supervisor-dashboard-allocated_count/client/' + Id, { headers: new Headers({ 'Access_Token': this.TokenCls.GetToken() }) });
  }
